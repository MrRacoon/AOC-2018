...
var file = "src/day2/input"

var sumTwos = 0
var sumThrees = 0

for line in file.lines:
  var digitCounter = initTable[char, int]()
  var hasTwo = false
  var hasThree = false

  for c in line:
    var currValue = getOrDefault(digitCounter, c)
    digitCounter[c] = currValue + 1


  for k, v in digitCounter:
    if v == 2:
      hasTwo = true
    if v == 3:
      hasThree = true
...
echo "part1 answer: ", sumThrees * sumTwos
